...
<%@ page errorPage="views/error/error.jsp" contentType="text/html;charset=UTF-8" language="java" %><!DOCTYPE html>
    ...
    <main>
        ...
        <section id="news" class="news-box">
            <article class="card">
                ...
                <p><a href="views/aplication/play-music.jsp">Escuchar ahora</a></p>
            </article>
